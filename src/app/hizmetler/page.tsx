...
const conditionsTreated: ServiceItem[] = [
  ...
  { slug: 'rahim-anomalileri', title: 'Rahim Anomalileri', longDescription: 'Myom, polip, rahim içi yapışıklıklar veya perde gibi doğuştan gelen ya da sonradan oluşan yapısal bozukluklardır. Embriyonun tutunmasını engelleyebilir.', imageSrc: '/rahim-anomalileri.webp' },
