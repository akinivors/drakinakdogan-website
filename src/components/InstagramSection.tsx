...
// You can hand-pick your 6 best images here
    ...
    <section className="w-full bg-white py-20">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="font-sans text-lg text-text-light mb-12">
          En güncel bilgiler, hasta hikayeleri ve klinik yaşamından anlar için <a href="https://www.instagram.com/draysinakdogan/" target="_blank" rel="noopener noreferrer" className="font-bold text-primary hover:underline">@draysinakdogan</a> hesabını takip edin.
        </p>
